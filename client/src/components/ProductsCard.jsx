  ...
  return (
    <div className="w-full relative group">
      <div
        ...
        className="w-full h-96 cursor-pointer overflow-hidden border-4 shadow-2xl shadow-violet-300 border-violet-700 rounded-t-xl"
      >
        <img
      ...
      <div className="w-full border-[1px] border-violet-700 rounded-b-xl px-2 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm relative w-28 flex justify-end overflow-hidden md">
            <div className="flex gap-2 transform group-hover:translate-x-28 transition-transform duration-500">
              <p className="line-through text-gray-500">${product.oldPrice || (product.price+20).toFixed()}</p>
